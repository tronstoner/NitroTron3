...
static constexpr float  VESTIGE_FADE_ATTACK_MAX_S  = 3.0f;  // K5 CW: swell-in finishes in this
static constexpr float  VESTIGE_FADE_RELEASE_MAX_S = 3.0f;  // K5 CW: fade-out finishes in this
