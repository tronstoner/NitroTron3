...
- **FLASH at ~97%** — climbed during the global preset / banks rewrite plus Mode C work (bass 97.4%, guitar variant 97.5%). Migration still ready via one-line linker swap to `STM32H750IB_qspi.lds` once it pushes past 100% or audio code needs the headroom.
