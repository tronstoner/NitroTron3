...
- **Mode C (Schism)** — IN PROGRESS. C.1 scaffold DONE: `ProcessFreqShift()` wires K5 wet level + K6 equal-power dry/wet mix. Wet path is unity copy of dry (SW1/SW2 stages unwired). K1–K4 unused this stage.
- **Next** — Mode C C.2: port sine wavefolder under SW1=UP with K4 fold amount. FS1+FS2 dual-hold bootloader (Phase 2) and pitch tracking improvements still deferred.
