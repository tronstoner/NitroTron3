...
MODES = {
    ...
    "b": {
        ...
        "sw2": ("SW2 · Harmony", ["Fixed interval", "Harmonic", "Harmonic"]),
        "sw3": ("SW3 · Mode select", ["Bordun", "Sprawl ◀", "Schism"]),
        "fs1": "FS1 · Preset",
        "fs2": "FS2 · Bypass",
    },
    "c": {
        ...
        "sw1": ("SW1 · Drive", ["Sine wavefold", "XOR Crusher", "Ensemble OSC"]),
        "sw2": ("SW2 · Filter", ["Moog ladder", "Grendel formant", "Plague Bearer"]),
        "sw3": ("SW3 · Mode select", ["Bordun", "Sprawl", "Schism ◀"]),
        "fs1": "FS1 · Preset",
        "fs2": "FS2 · Bypass",
    },
