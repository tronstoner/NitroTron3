...
| KNOB 3 | Smoothness | CCW = looper (long grains, plays through 1×) → CW = freeze (read head time-stretches to a standstill; grains phase around a fixed point — consistent, not random scatter) |
