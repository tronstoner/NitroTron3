...
| KNOB 4 | Drive character | SW1=UP: sine wavefold amount (0 = clean, 1 = max fold, internal loudness compensation). SW1=MID: bit-crush amount (CCW = 16-bit clean, CW = 4-bit gnarly). SW1=DOWN: unused |
...
| KNOB 6 | Mix | 0 = full dry, 1 = full wet. Equal-power curve |
| SWITCH 1 | Drive | **UP** - Sine wavefolder (K4 = fold amount)<br/>**MIDDLE** - Gated bit crusher (K4 = bit depth 16 → 4, env-gated)<br/>**DOWN** - Passthrough |
